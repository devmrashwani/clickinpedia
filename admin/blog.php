            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>Blogs </h3>
                        <a class="button button-outline button-primary mt-5" href='./manage-blog.php'>Add Blog</a>
                    </div>
                        ...
                        <table class="table table-vertical-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>".substr($row['short_desc'],0,100)."</td>
                                    <td>".$row['date']."</td>
                                    <td>".$row['a_name']."</td>
                                    <td>".$row['a_desi']."</td>
                                    <td class='action h4'>
                                        <div class='table-action-buttons'>
                                            <a class='edit button button-box button-xs button-info' href='./manage-blog.php?id=".$row['id']."'><i class='zmdi zmdi-edit'></i></a>
