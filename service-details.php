...
if(isset($_POST['submit']))
{
   ...
   if($result){
      ...
      header("Location:./service-details.php?id=".$id."&ok=Thank You We Will contact You ASAP&#ok");
   }
}
?>
...
<head>
   ...
   <title>ClickinPedia -Service Details Page</title>
...
include "include/menu.php" ;
 ?>
   ...
   <main>
         ...
         <div class="row">
            <div class="col-xxl-12">
               <div class="breadcrumb__content">
                  <h3 class="breadcrumb__title"><?php echo $row['name'];?></h3>
      ...
      <div class="sv-details-area pt-120">
         <div class="container">
            <div class="row">
               <div class="col-xl-12">
                  <div class="sv-details-content">
                     <div class="sv-details-thumb mb-50">
                        <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$row['image']?>" alt="">
                     </div>
                     <h1 class="sv-details-title mb-60"><?php echo $row['name'];?></h1>
                     <p class="pb-30">
